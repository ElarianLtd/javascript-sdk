...
function serialize_com_elarian_hera_proto_InitiatePaymentRequest(arg) {
  if (!(arg instanceof web_pb.InitiatePaymentRequest)) {
    throw new Error('Expected argument of type com.elarian.hera.proto.InitiatePaymentRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_com_elarian_hera_proto_InitiatePaymentRequest(buffer_arg) {
  return web_pb.InitiatePaymentRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var GrpcWebServiceService = exports.GrpcWebServiceService = {
  ...
  initiatePayment: {
    path: '/com.elarian.hera.proto.GrpcWebService/InitiatePayment',
    requestStream: false,
    responseStream: false,
    requestType: web_pb.InitiatePaymentRequest,
    responseType: web_pb.InitiatePaymentReply,
    requestSerialize: serialize_com_elarian_hera_proto_InitiatePaymentRequest,
    requestDeserialize: deserialize_com_elarian_hera_proto_InitiatePaymentRequest,
