...
/**
 * An obkect representing a paymennt reply
 ...
 * @property {string} number
 * @property {string} provider one of [cellular|telegram|facebook|email|web]
 * @property {string} [partition]
 */
 ...
 * @property {string} sessionId
 * @property {CustomerNumber} customerNumber
 * @property {ActivityChannelNumber} channelNumber
 ...
 * @property {string} number
 * @property {string} channel channel type. Must be one of ['web','mobile']
 */
