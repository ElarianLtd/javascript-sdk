 ...
 * @property {string} [authToken] received from an client that authenticated with the API key. @see Client.getAuthToken()
 * @property {string} [receivedNotifications] allow this client to receive notifications or not
 */
 ...
 * @returns {UssdMenu|VoiceAction[]|void} A response to the event. Required for voice and ussd events
 */
