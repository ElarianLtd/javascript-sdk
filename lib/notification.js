...
const { log, ElarianMessages, addVoiceCallActions } = require('./utils');
...
const notificationHandler = (incomingPayload) => {
    const handlePayload = async () => {
        ...
        const customer = new Customer({ customerId: data.customerId });
