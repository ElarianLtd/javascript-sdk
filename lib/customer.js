...
function Customer(params) {
     ...
     * @returns {UpdateStatus}
     */
    this.updateAppData = async (data) => updateCustomerAppData(this, data);
     ...
     */
    this.leaseAppData = async () => leaseCustomerAppData(this);

    /**
     * Remove customer's app data
     * @returns {UpdateStatus}
     */
    this.deleteAppData = async () => deleteCustomerAppData(this);
     ...
     */
    // eslint-disable-next-line max-len
    this.updateActivity = async (channelNumber, activity) => updateCustomerActivity(this.customerNumber, channelNumber, activity);
                ...
                onComplete: (value) => {
                    try {
                        ...
                        if (result.data.identityState && Object.keys(result.data.identityState).length) {
                            const { serializer: { type, deserialize } } = this.client.configOptions;
 ...
 * @memberof Elarian.prototype
 */
async function adoptCustomerState(customer, otherCustomer) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function updateCustomerTag(customer, tags) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function deleteCustomerTag(customer, tags) {
    const socket = this.getSocket();
...
/**
  ...
  * @memberof Elarian.prototype
  */
async function updateCustomerSecondaryId(customer, secondaryIds) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function deleteCustomerSecondaryId(customer, secondaryIds) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function cancelCustomerReminder(customer, key) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function addCustomerReminderByTag(tag, reminder) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function cancelCustomerReminderByTag(tag, key) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function updateCustomerMetadata(customer, metadata) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function updateCustomerAppData(customer, data) {
    const socket = this.getSocket();
    const { serializer } = this.configOptions;
 ...
 * @memberof Elarian.prototype
 */
async function leaseCustomerAppData(customer) {
    const socket = this.getSocket();
    const { serializer } = this.configOptions;
 ...
 * @memberof Elarian.prototype
 */
async function deleteCustomerAppData(customer) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function updateCustomerActivity(customerNumber, channelNumber, activity) {
    const socket = this.getSocket();
...
module.exports = {
    ...
    setup: (client) => {
        ...
        client.leaseCustomerAppData = leaseCustomerAppData;
        client.updateCustomerAppData = updateCustomerAppData;
        client.deleteCustomerAppData = deleteCustomerAppData;
