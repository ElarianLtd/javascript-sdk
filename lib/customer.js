...
function Customer(params) {
     ...
     * @returns {UpdateStatus}
     */
    this.updateAppData = async (data) => {
        await updateCustomerAppData(this, data);
        this.appData = data;
    };
     ...
     */
    this.leaseAppData = async () => {
        const data = await leaseCustomerAppData(this);
        this.appData = data;
        return this.appData;
    };
     ...
     * @returns {UpdateStatus}
     */
    this.deleteAppData = async () => {
        await deleteCustomerAppData(this);
        this.appData = {};
    };
     ...
     */
    // eslint-disable-next-line max-len
    this.webAction = async (domain, sessionId, key, properties = {}) => customerOptions.client.webAction(this.customerNumber, domain, sessionId, key, properties);
    /* eslint-enable no-use-before-define */
}
