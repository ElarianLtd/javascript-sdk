 ...
 */
function sendMessage(customer, channelNumber, message) {
 ...
 * @returns {WorkStatus}
 */
function sendMessageByTag(tag, channelNumber, message) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
async function replyToMessage(customer, replyToMessageId, message) {
    const socket = this.getSocket();
 ...
 * @memberof Elarian.prototype
 */
function updateMessagingConsent(customer, channelNumber, action) {
    const socket = this.getSocket();
